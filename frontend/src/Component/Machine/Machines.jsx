...
const MachineBoi = () => {
  ...
  return (
    ...
    <Fragment>
    <MetaData title={` MODEL :4D -- Ecommerce`}/>
     <div className="ProductDetails">
       ...
       <div>
         ...
         <p className='machineDesc'> <b className='machinedes-bold' > Description </b>: Dimensoin(L×W×H): 46×33×52 cm</p>
            <p className='machineDesc'> No. of Selection:Four</p>
            <p className='machineDesc'> No. of Hoppers:Four with easy fitting</p>
            <p className='machineDesc'> Premix Capacity:1kg</p>
            <p className='machineDesc'> Boiler Capacity:4.5Liters</p>
            ...
            <p className='machineDesc'> Water Filling Type : Pump</p>
            ...
            <p className='machineDesc'> Weight : 20kg(Approx)</p>
