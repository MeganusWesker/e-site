...
// register
export const register = (name,email,password,avatar) => async (disptach)=>{
...
// update profile
export const updateProfile = (name,email,avatar) => async (disptach)=>{
    ...
    try {
       ...
       const {data} = await axios.put('/api/v1/profile/update',{name,email,avatar},config);
